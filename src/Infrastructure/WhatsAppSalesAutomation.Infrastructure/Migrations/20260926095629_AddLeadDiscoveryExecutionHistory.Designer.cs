...
namespace WhatsAppSalesAutomation.Infrastructure.Migrations
{
    ...
    [Migration("20260926095629_AddLeadDiscoveryExecutionHistory")]
    partial class AddLeadDiscoveryExecutionHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhatsAppSalesAutomation.Domain.Entities.Audit.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "PerformedAt")
                        .HasDatabaseName("IX_AuditLogs_Tenant_PerformedAt");

                    b.HasIndex("TenantId", "PerformedBy")
                        .HasDatabaseName("IX_AuditLogs_Tenant_Actor");
            ...
            modelBuilder.Entity("WhatsAppSalesAutomation.Domain.Entities.Campaigns.AutoCampaignEnrollment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("DiscoveredLeadId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("ExecutionCampaignId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "SourceCampaignId", "CustomerId")
                        .IsUnique()
                        .HasFilter("[Status] = 'Started'");

                    b.HasIndex("TenantId", "SourceCampaignId", "ExecutionDateLocal");

                    b.ToTable("AutoCampaignEnrollments", (string)null);
                });
            ...
            modelBuilder.Entity("WhatsAppSalesAutomation.Domain.Entities.LeadDiscovery.LeadDiscoveryExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("AutoCampaignConfigured")
                        .HasColumnType("bit");

                    b.Property<Guid?>("AutoCampaignId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("CustomersDiscovered")
                        .HasColumnType("int");

                    b.Property<int>("CustomersDuplicate")
                        .HasColumnType("int");

                    b.Property<int>("CustomersFailed")
                        .HasColumnType("int");

                    b.Property<int>("CustomersInvalid")
                        .HasColumnType("int");
                    ...
                    b.Property<Guid?>("GeneratedCampaignId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("GeneratedCampaignName")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<Guid>("LeadDiscoveryProfileId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("LockLastRenewedAtUtc")
                        .HasColumnType("datetime2");

                    b.Property<string>("LockOwnerInstanceId")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<string>("LockTokenReference")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.Property<int>("MappingsCreated")
                        .HasColumnType("int");

                    b.Property<int>("MappingsEligible")
                        .HasColumnType("int");

                    b.Property<int>("MappingsExisting")
                        .HasColumnType("int");

                    b.Property<int>("MappingsFailed")
                        .HasColumnType("int");

                    b.Property<string>("NextRetryInfo")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<Guid?>("ReferredCampaignId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ReferredCampaignName")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<Guid?>("SupersededByExecutionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RootExecutionId");

                    b.HasIndex("TenantId", "ProcessingDate");

                    b.HasIndex("TenantId", "LeadDiscoveryProfileId", "Status");

                    b.ToTable("LeadDiscoveryExecutions", (string)null);
                });

            modelBuilder.Entity("WhatsAppSalesAutomation.Domain.Entities.LeadDiscovery.LeadDiscoveryExecutionCustomer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LeadDiscoveryExecutionCustomers", (string)null);
                });

            modelBuilder.Entity("WhatsAppSalesAutomation.Domain.Entities.LeadDiscovery.LeadDiscoveryExecutionTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LeadDiscoveryExecutionTemplates", (string)null);
                });

            modelBuilder.Entity("WhatsAppSalesAutomation.Domain.Entities.LeadDiscovery.LeadDiscoveryGeneratedCampaign", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "LeadDiscoveryProfileId", "AutoCampaignId", "ProcessingDate")
                        .IsUnique();

                    b.ToTable("LeadDiscoveryGeneratedCampaigns", (string)null);
                });

            modelBuilder.Entity("WhatsAppSalesAutomation.Domain.Entities.LeadDiscovery.LeadDiscoveryLock", b =>
                {
                    b.Property<string>("LockKey")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.ToTable("LeadDiscoveryLocks", (string)null);
                });

            modelBuilder.Entity("WhatsAppSalesAutomation.Domain.Entities.LeadDiscovery.LeadDiscoveryLockTransition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("TransitionAtUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("ExecutionId", "TransitionAtUtc");

                    b.ToTable("LeadDiscoveryLockTransitions", (string)null);
                });
            ...
            modelBuilder.Entity("WhatsAppSalesAutomation.Domain.Entities.Leads.Lead", b =>
                {
                    ...
                    b.HasIndex("TenantId", "HotLeadDetectedAt")
            ...
            modelBuilder.Entity("WhatsAppSalesAutomation.Domain.Entities.Platform.FaqEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WhatsAppSalesAutomation.Domain.Entities.Platform.Flowchart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Flowcharts", (string)null);
                });
            ...
            modelBuilder.Entity("WhatsAppSalesAutomation.Domain.Entities.LeadDiscovery.LeadDiscoveryExecutionCustomer", b =>
                {
                    b.HasOne("WhatsAppSalesAutomation.Domain.Entities.LeadDiscovery.LeadDiscoveryExecution", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WhatsAppSalesAutomation.Domain.Entities.Leads.LeadScoreContribution", b =>
                {
                    b.HasOne("WhatsAppSalesAutomation.Domain.Entities.Leads.Lead", null)
                        .WithMany("ScoreContributions")
                        .HasForeignKey("LeadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WhatsAppSalesAutomation.Domain.Entities.Leads.LeadScoringRule", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WhatsAppSalesAutomation.Domain.Entities.Leads.Lead", b =>
                {
                    ...
                    b.Navigation("QualificationValues");

                    b.Navigation("ScoreContributions");
                });
